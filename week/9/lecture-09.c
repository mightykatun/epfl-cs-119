...
void test_dynarray_newempty() {
  dynarray_t a1 = create_dynarray();
  assert(dynarray_size(&a1) == 0);
  free_dynarray(&a1);
}

void test_dynarray_add_get() {
  dynarray_t a1 = create_dynarray();
  dynarray_add(&a1, 56);
  dynarray_add(&a1, 32);
  assert(dynarray_size(&a1) == 2);
  assert(dynarray_get(&a1, 0) == 56);
  assert(dynarray_get(&a1, 1) == 32);
  free_dynarray(&a1);
}

void test_dynarray_set() {
  dynarray_t a1 = create_dynarray();
  dynarray_add(&a1, 56);
  dynarray_add(&a1, 32);
  dynarray_set(&a1, 0, 14);
  dynarray_add(&a1, 21);
  dynarray_add(&a1, 48);
  dynarray_set(&a1, 2, 5);
  assert(dynarray_size(&a1) == 4);
  assert(dynarray_get(&a1, 0) == 14);
  assert(dynarray_get(&a1, 1) == 32);
  assert(dynarray_get(&a1, 2) == 5);
  assert(dynarray_get(&a1, 3) == 48);
  free_dynarray(&a1);
}

void test_dynarray_shrink() {
  dynarray_t a1 = create_dynarray();
  dynarray_add(&a1, 56);
  dynarray_add(&a1, 32);
  dynarray_add(&a1, 21);
  dynarray_add(&a1, 48);
  dynarray_add(&a1, 5);
  dynarray_shrink(&a1, 3);
  assert(dynarray_size(&a1) == 3);
  assert(dynarray_get(&a1, 0) == 56);
  assert(dynarray_get(&a1, 1) == 32);
  assert(dynarray_get(&a1, 2) == 21);
  free_dynarray(&a1);
}

void test_insertion_sort() {
  dynarray_t a = create_dynarray();
  dynarray_add(&a, 5);
  dynarray_add(&a, 8);
  dynarray_add(&a, 4);
  dynarray_add(&a, 3);
  ...
  assert(dynarray_size(&a) == 8);
  assert(dynarray_get(&a, 0) == 3);
  assert(dynarray_get(&a, 1) == 4);
  assert(dynarray_get(&a, 2) == 5);
  assert(dynarray_get(&a, 3) == 5);
  assert(dynarray_get(&a, 4) == 7);
  assert(dynarray_get(&a, 5) == 8);
  assert(dynarray_get(&a, 6) == 10);
  assert(dynarray_get(&a, 7) == 34);
  free_dynarray(&a);
}

void test_all() {
  test_dynarray_newempty();
  test_dynarray_add_get();
  test_dynarray_set();
  test_dynarray_shrink();
